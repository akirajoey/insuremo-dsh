...
export const COMMANDS = {
  ...
  writeTestRun: "icomposer-write/test-run",
  writeReleasePreview: "icomposer-write/release-preview",
  writeReleaseRepos: "icomposer-write/release-repos",
  writeReleaseBranches: "icomposer-write/release-branches",
  writeReleaseApply: "icomposer-write/release-apply",
  writeCreateOptions: "icomposer-write/create-options",
  writeCreatePreview: "icomposer-write/create-preview",
  ...
  intercomAsk: "intercom/ask",
  intercomReply: "intercom/reply",
  intercomCancel: "intercom/cancel",
  intercomPendingAsks: "intercom/pending-asks",
  intercomResolveStatus: "intercom/resolve-status",
